...
JS;
    ...
    public function admin_cancel_booking()
    {
        ...
        if ($ok === false) wp_send_json_error(array('message' => 'خطا در لغو'));
                    ...
                    <form id="mbp-sms-settings-form">
                        <div style="background:#f9fafb;border:1px solid #e5e7eb;border-radius:10px;padding:20px;margin-bottom:20px;">
                            ...
                            <div style="margin-bottom:15px;">
                                ...
                                <input type="text" id="mbp-sms-sender" name="sender_number" value="<?php echo esc_attr($sms_settings->sender_number ?? ''); ?>" class="regular-text" style="width:100%;" placeholder="مانند: 10004346">
                                <p style="font-size:12px;color:#6b7280;margin-top:5px;">
                        ...
                        <div style="background:#f9fafb;border:1px solid #e5e7eb;border-radius:10px;padding:20px;margin-bottom:20px;">
                            ...
                            <div style="margin-bottom:15px;">
                                <label style="font-weight:800;display:flex;align-items:center;gap:8px;margin-bottom:5px;">
                                    <input type="checkbox" id="mbp-enable-booking-sms" name="enable_booking_sms" value="1" <?php checked($sms_settings->enable_booking_sms ?? 1, 1); ?>>
                            ...
                            <div style="margin-bottom:15px;">
                                <label style="font-weight:800;display:flex;align-items:center;gap:8px;margin-bottom:5px;">
                                    <input type="checkbox" id="mbp-enable-payment-sms" name="enable_payment_sms" value="1" <?php checked($sms_settings->enable_payment_sms ?? 1, 1); ?>>
                            ...
                            <div style="margin-bottom:15px;">
                                <label style="font-weight:800;display:flex;align-items:center;gap:8px;margin-bottom:5px;">
                                    <input type="checkbox" id="mbp-enable-reminder-sms" name="enable_reminder_sms" value="1" <?php checked($sms_settings->enable_reminder_sms ?? 0, 1); ?>>
                                    ارسال پیامک یادآوری
                                </label>
                                <div style="margin-right:24px;">
                                    <div style="margin-top:10px;">
                                        <label style="font-weight:600;display:block;margin-bottom:5px;">ساعت‌های قبل از نوبت برای یادآوری</label>
                                        <input type="number" id="mbp-reminder-hours" name="reminder_hours" value="<?php echo esc_attr($sms_settings->reminder_hours ?? 24); ?>" class="small-text" min="1" max="168" style="width:80px;">
                    ...
                    <form id="mbp-payment-settings-form">
                        ...
                        <div style="background:#f9fafb;border:1px solid #e5e7eb;border-radius:10px;padding:20px;margin-bottom:20px;">
                            ...
                            <div style="margin-bottom:15px;">
                                ...
                                <input type="text" id="mbp-zarinpal-merchant-id" name="zarinpal_merchant_id" value="<?php echo esc_attr($payment_settings['zarinpal_merchant_id']); ?>" class="regular-text" style="width:100%;" placeholder="xxxxxxxx-xxxx-xxxx-xxxx-xxxxxxxxxxxx">
                                <p style="font-size:12px;color:#6b7280;margin-top:5px;">
                        ...
                        <div style="background:#f9fafb;border:1px solid #e5e7eb;border-radius:10px;padding:20px;margin-bottom:20px;">
                            ...
                            <div style="margin-bottom:15px;">
                                <label style="font-weight:800;display:block;margin-bottom:5px;">API Key</label>
                                <input type="text" id="mbp-idpay-api-key" name="idpay_api_key" value="<?php echo esc_attr($payment_settings['idpay_api_key']); ?>" class="regular-text" style="width:100%;" placeholder="xxxxxxxx-xxxx-xxxx-xxxx-xxxxxxxxxxxx">
                            </div>
                        ...
                        <div style="background:#f9fafb;border:1px solid #e5e7eb;border-radius:10px;padding:20px;margin-bottom:20px;">
                            ...
                            <div style="margin-bottom:15px;">
                                <label style="font-weight:800;display:block;margin-bottom:5px;">API Key</label>
                                <input type="text" id="mbp-nextpay-api-key" name="nextpay_api_key" value="<?php echo esc_attr($payment_settings['nextpay_api_key']); ?>" class="regular-text" style="width:100%;">
                            </div>
                        </div>
                    ...
                    <form id="mbp-general-settings-form">
                        <div style="background:#f9fafb;border:1px solid #e5e7eb;border-radius:10px;padding:20px;margin-bottom:20px;">
                            ...
                            <div style="margin-bottom:15px;">
                                ...
                                <input type="number" id="mbp-auto-approve-hours" name="auto_approve_hours" value="<?php echo esc_attr(get_option('mbp_auto_approve_hours', 0)); ?>" class="regular-text" style="width:100px;">
                                <p style="font-size:12px;color:#6b7280;margin-top:5px;">
                                    اگر عددی بیشتر از 0 وارد کنید، رزروها بعد از این مدت به صورت خودکار تأیید می‌شوند (0 = غیرفعال)
                                </p>
                            </div>
                            
                            <div style="margin-bottom:15px;">
                                <label style="font-weight:800;display:block;margin-bottom:5px;">زمان لغو خودکار (ساعت)</label>
                                <input type="number" id="mbp-auto-cancel-hours" name="auto_cancel_hours" value="<?php echo esc_attr(get_option('mbp_auto_cancel_hours', 0)); ?>" class="regular-text" style="width:100px;">
                                <p style="font-size:12px;color:#6b7280;margin-top:5px;">
                        ...
                        <div style="background:#f9fafb;border:1px solid #e5e7eb;border-radius:10px;padding:20px;margin-bottom:20px;">
                            ...
                            <div style="margin-bottom:15px;">
                                <label style="font-weight:800;display:block;margin-bottom:5px;">تعداد روزهای قابل رزرو در آینده</label>
                                <input type="number" id="mbp-future-days-limit" name="future_days_limit" value="<?php echo esc_attr(get_option('mbp_future_days_limit', 30)); ?>" class="regular-text" style="width:100px;" min="1" max="365">
                                <p style="font-size:12px;color:#6b7280;margin-top:5px;">
...
// در متد enqueue_admin_assets استایل اضافه کنید:
        ...
        <div style="max-width:600px;">
            <form id="mbp-sms-settings-form">
                <div style="background:#f9fafb;border:1px solid #e5e7eb;border-radius:10px;padding:20px;margin-bottom:20px;">
                    ...
                    <div style="margin-bottom:15px;">
                        <label style="font-weight:800;display:block;margin-bottom:5px;">API Key</label>
                        <input type="text" id="mbp-sms-api-key" name="api_key" value="<?php echo esc_attr($settings->api_key); ?>" class="regular-text" style="width:100%;" placeholder="کلید API سرویس پیامک">
                        <p style="font-size:12px;color:#6b7280;margin-top:5px;">
                            API Key را از پنل سرویس پیامک خود دریافت کنید
                        </p>
                    </div>
                    ...
                    <div style="margin-bottom:15px;">
                        <label style="font-weight:800;display:block;margin-bottom:5px;">شماره فرستنده</label>
                        <input type="text" id="mbp-sms-sender" name="sender_number" value="<?php echo esc_attr($settings->sender_number); ?>" class="regular-text" style="width:100%;" placeholder="مانند: 10004346">
                        <p style="font-size:12px;color:#6b7280;margin-top:5px;">
                            شماره فرستنده اختصاصی شما از سرویس پیامک
                        </p>
                    </div>
                ...
                <div style="background:#f9fafb;border:1px solid #e5e7eb;border-radius:10px;padding:20px;margin-bottom:20px;">
                    ...
                    <div style="margin-bottom:15px;">
                        ...
                        <div style="margin-right:24px;">
                            <div style="margin-top:10px;">
                                <label style="font-weight:600;display:block;margin-bottom:5px;">ساعت‌های قبل از نوبت برای یادآوری</label>
                                <input type="number" id="mbp-reminder-hours" name="reminder_hours" value="<?php echo esc_attr($settings->reminder_hours); ?>" class="small-text" min="1" max="168" style="width:80px;">
                                <span style="font-size:12px;color:#6b7280;">ساعت</span>
                            </div>
                            <p style="font-size:12px;color:#6b7280;margin-top:5px;">
                                قبل از زمان نوبت، پیامک یادآوری برای کاربر ارسال می‌شود
        ...
        <div style="max-width:600px;">
            <form id="mbp-payment-settings-form">
                ...
                <div style="background:#f9fafb;border:1px solid #e5e7eb;border-radius:10px;padding:20px;margin-bottom:20px;">
                    ...
                    <div style="margin-bottom:15px;">
                        <label style="font-weight:800;display:block;margin-bottom:5px;">مرچنت کد (Merchant ID)</label>
                        <input type="text" id="mbp-zarinpal-merchant-id" name="zarinpal_merchant_id" value="<?php echo esc_attr($zarinpal_merchant_id); ?>" class="regular-text" style="width:100%;" placeholder="xxxxxxxx-xxxx-xxxx-xxxx-xxxxxxxxxxxx">
                        <p style="font-size:12px;color:#6b7280;margin-top:5px;">
                            Merchant ID را از پنل زرین‌پال دریافت کنید
                        </p>
                    </div>
                ...
                <div style="background:#f9fafb;border:1px solid #e5e7eb;border-radius:10px;padding:20px;margin-bottom:20px;">
                    ...
                    <div style="margin-bottom:15px;">
                        <label style="font-weight:800;display:block;margin-bottom:5px;">API Key</label>
                        <input type="text" id="mbp-idpay-api-key" name="idpay_api_key" value="<?php echo esc_attr($idpay_api_key); ?>" class="regular-text" style="width:100%;" placeholder="xxxxxxxx-xxxx-xxxx-xxxx-xxxxxxxxxxxx">
                    </div>
                ...
                <div style="background:#f9fafb;border:1px solid #e5e7eb;border-radius:10px;padding:20px;margin-bottom:20px;">
                    ...
                    <div style="margin-bottom:15px;">
                        <label style="font-weight:800;display:block;margin-bottom:5px;">API Key</label>
                        <input type="text" id="mbp-nextpay-api-key" name="nextpay_api_key" value="<?php echo esc_attr($nextpay_api_key); ?>" class="regular-text" style="width:100%;">
                    </div>
                </div>
        ...
        if (empty($appointments)) {
            ...
            foreach ($appointments as $appointment) {
                ...
                switch ($appointment->status) {
                    case 'pending': $status_text = 'در انتظار تأیید'; break;
                    case 'approved': $status_text = 'تأیید شده'; break;
                    case 'cancelled': $status_text = 'لغو شده'; break;
                    default: $status_text = $appointment->status;
                }
                
                $payment_status_text = '';
                switch ($appointment->payment_status) {
                    case 'paid': $payment_status_text = 'پرداخت شده'; break;
                    case 'unpaid': $payment_status_text = 'پرداخت نشده'; break;
                    case 'pending': $payment_status_text = 'در انتظار پرداخت'; break;
                    default: $payment_status_text = $appointment->payment_status;
                }
    ...
    public function render_services_list($atts = array())
    {
        ...
        <div class="mbp-services-grid" style="grid-template-columns: repeat(<?php echo esc_attr($atts['columns']); ?>, 1fr);">
            ...
            <div class="mbp-service-card">
                ...
                <div style="margin-top:12px;">
                    <button type="button" class="mbp-submit mbp-submit-primary" style="width:100%;" onclick="selectService(<?php echo $service->id; ?>)">
                        انتخاب این خدمت
                    </button>
                </div>
                <?php endif; ?>
            ...
            <form id="mbp-booking-form" class="mbp-form" method="post">
                <div style="display:flex;justify-content:space-around;gap:12px;flex-wrap:wrap;">
                    ...
                    <p class="mbp-field" style="min-width:260px;flex:1;">
                        <label for="mbp-name" class="mbp-label"><?php esc_html_e('نام و نام خانوادگی:', 'my-booking-plugin'); ?></label>
                        <input type="text" dir="rtl" id="mbp-name" name="customer_name" required class="mbp-input mbp-ltr" style="border-radius: 10px;">
                    </p>

                    <p class="mbp-field" style="min-width:260px;flex:1;">
                        <label for="mbp-email" class="mbp-label"><?php esc_html_e('ایمیل:', 'my-booking-plugin'); ?></label>
                        <input type="email" id="mbp-email" name="customer_email" required class="mbp-input mbp-ltr" style="border-radius: 10px;">
                    </p>

                    <p class="mbp-field" style="min-width:260px;flex:1;">
                        <label for="mbp-phone" class="mbp-label"><?php esc_html_e('شماره موبایل:', 'my-booking-plugin'); ?></label>
                        <input type="tel" id="mbp-phone" name="customer_phone" required class="mbp-input mbp-ltr" style="border-radius: 10px;" pattern="^09[0-9]{9}$" placeholder="09123456789">
                    </p>
                </div>
                ...
                <div style="display:flex;justify-content:space-around;gap:12px;flex-wrap:wrap;">
                   ...
                   <p class="mbp-field" style="min-width:260px;flex:1;">
                        ...
                        <input type="text" id="mbp-date" name="date" required class="mbp-input" style="border-radius: 10px;" readonly placeholder="رو جدولانتخاب کنید">
                    </p>
                    <p class="mbp-field" style="min-width:260px;flex:1;">
                ...
                <div id="mbp-service-price" style="display:none;margin:15px 0;padding:12px;background:#f0fdf4;border:1px solid #bbf7d0;border-radius:8px;">
    ...
    public function handle_booking_submit()
    {
        ...
        wp_send_json_success(array(
            'message' => 'رزرو با موفقیت ثبت شد و در انتظار تأیید است.',
            'needs_payment' => false
        ));
    }
                                            ...
                                            <div class="mbp-booking-card" data-id="<?php echo esc_attr($a->id); ?>">
                                                ...
                                                <div class="mbp-booking-actions">
                                                    ...
                                                    <?php if ($status !== 'cancelled'): ?>
                                                        <button class="mbp-btn mbp-cancel" data-id="<?php echo esc_attr($a->id); ?>">لغو</button>
                                                    <?php endif; ?>
            ...
            <main class="mbp-main">
                <div class="mbp-topbar">
                    <div style="font-weight:800;display:flex;align-items:center;gap:10px;">
                        ...
                        <span style="font-size:12px;opacity:.7;background:rgba(59,130,246,.2);padding:2px 8px;border-radius:10px;">
                            پنل مدیریت
                        </span>
                    </div>
                    <div>
                ...
                <div id="tpl-dashboard" style="display:none">
                    ...
                    <div class="stats-grid">
                        ...
                        <div class="stat-card income">
                            ...
                            <div class="num" id="mbp-income"><?php echo esc_html($this->fa_digits(number_format($total_income))); ?> تومان</div>
                        </div>
                        
                        <div class="stat-card pending">
                            <div class="label">در انتظار تأیید</div>
                            <div class="num" id="mbp-pending"><?php echo esc_html($this->fa_digits($count_pending)); ?></div>
                        </div>
                        
                        <div class="stat-card approved">
                            <div class="label">تأیید شده</div>
                            <div class="num" id="mbp-approved"><?php echo esc_html($this->fa_digits($count_approved)); ?></div>
                        </div>
                    </div>
                ...
                <div id="tpl-custom_fields" style="display:none">
                    ...
                    <div class="panel">
                        ...
                        <textarea id="mbp-slots-text" class="slots-ta" placeholder="09:00&#10;09:30&#10;10:00&#10;10:30&#10;11:00&#10;11:30&#10;12:00"></textarea>
                    ...
                    try {
                        ...
                        function render(name) {
                            ...
                            if (name === 'dashboard') {
                                ...
                                mount('tpl-services'); 
                                // بارگذاری با تاخیر برای اطمینان از render شدن DOM
                                setTimeout(() => {
                                    loadServices();
                                }, 100);
